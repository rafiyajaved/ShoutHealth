...
var authToken = "6bbf2e8266899ba9ff08ff5753359e79";
// var client = require('twilio');

let url =
  "https://api.twilio.com/2010-04-01/Accounts/ACebb6ec186e9eb445f028f383dc5d6dc0/Messages";
...
export function sendSMS(data, phoneNumberString) {
  ...
  $.ajax({
    ...
    beforeSend: function(xhr) {
      xhr.setRequestHeader("Authorization", "Basic " + btoa(accountSid +
        ':' + authToken));
    },
